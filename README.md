# Exercise 09 — Leader Election (Bully Algorithm)
...
|------|-------|-------------------|
| **U2.2 Election algorithms** | Bully algorithm | Implement Bully leader election across multiple Node Registry instances. |
...
**Deadline: Sunday, September 20, 2026 at 23:59 (UTC-3)** (2 late days allowed with penalty)

---

## Context

Implement Bully leader election across multiple Node Registry instances.
